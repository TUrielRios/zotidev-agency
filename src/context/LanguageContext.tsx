...
const translations = {
  es: {
    ...
    'portfolio.project7.title': 'Reserva tus Turnos',
    'portfolio.project7.description': 'Sistema integral de gestión de turnos y citas que permite a negocios gestionar reservas, clientes y profesionales. Incluye dashboards analíticos, calendario inteligente y tracking financiero en tiempo real.',

    'portfolio.project8.title': 'Elite Rent Group',
    'portfolio.project8.description': 'Landing page moderna para servicio de alquiler de vehículos premium en Miami, Florida. Diseño responsive con experiencia optimizada para conversiones y reservas instantáneas.',
    ...
    'portfolio.project7.challenge': 'Los negocios de servicios necesitaban una plataforma completa que simplificara la gestión de citas, permitiera el seguimiento de clientes y ofreciera análisis de rendimiento financiero.',
    'portfolio.project7.solution': 'Desarrollamos una plataforma SaaS integral con gestión de turnos multicanal, sistema de clientes, calendario inteligente, dashboards analíticos y módulo financiero completo.',
    'portfolio.project7.results': 'Más de 200 negocios utilizando la plataforma, reducción del 80% en tiempos de gestión de citas y aumento del 45% en retención de clientes gracias a las notificaciones automatizadas.',
    'portfolio.project7.client': 'Reserva tus Turnos - Plataforma SaaS',
    'portfolio.project7.feature1': 'Gestión completa de turnos y calendario',
    'portfolio.project7.feature2': 'Dashboard con métricas en tiempo real',
    'portfolio.project7.feature3': 'Sistema de notificaciones automatizadas',
    'portfolio.project7.feature4': 'Módulo de análisis financiero y reportes',
    'portfolio.project7.image1.caption': 'Dashboard principal del sistema',

    'portfolio.project8.challenge': 'La empresa necesitaba una presencia digital atractiva que reflejara el carácter premium de sus vehículos y facilitara las reservas en línea para turistas en Miami.',
    'portfolio.project8.solution': 'Creamos una landing page moderna con diseño elegante, galería de vehículos premium, sistema de cotización instantánea y optimización para conversiones.',
    'portfolio.project8.results': 'Incremento del 65% en solicitudes de reserva, mejor posicionamiento en búsquedas locales y experiencia de usuario fluida que refleja la calidad del servicio.',
    'portfolio.project8.client': 'Elite Rent Group - Miami',
    'portfolio.project8.feature1': 'Diseño responsive y moderno',
    'portfolio.project8.feature2': 'Galería de vehículos premium',
    'portfolio.project8.feature3': 'Sistema de cotización instantánea',
    'portfolio.project8.feature4': 'Optimización SEO para búsquedas locales',
    'portfolio.project8.image1.caption': 'Página principal de Elite Rent Group',
    // Footer
  ...
  en: {
    ...
    'portfolio.project7.title': 'Reserva tus Turnos',
    'portfolio.project7.description': 'Comprehensive appointment and booking management system that allows businesses to manage reservations, clients, and professionals. Includes analytical dashboards, smart calendar, and real-time financial tracking.',

    'portfolio.project8.title': 'Elite Rent Group',
    'portfolio.project8.description': 'Modern landing page for premium car rental service in Miami, Florida. Responsive design with conversion-optimized experience and instant booking capabilities.',
    ...
    'portfolio.project7.challenge': 'Service businesses needed a complete platform to simplify appointment management, enable client tracking, and provide financial performance analytics.',
    'portfolio.project7.solution': 'We developed a comprehensive SaaS platform with multi-channel appointment management, client system, smart calendar, analytical dashboards, and complete financial module.',
    'portfolio.project7.results': 'Over 200 businesses using the platform, 80% reduction in appointment management time, and 45% increase in client retention thanks to automated notifications.',
    'portfolio.project7.client': 'Reserva tus Turnos - SaaS Platform',
    'portfolio.project7.feature1': 'Complete appointment and calendar management',
    'portfolio.project7.feature2': 'Dashboard with real-time metrics',
    'portfolio.project7.feature3': 'Automated notification system',
    'portfolio.project7.feature4': 'Financial analysis and reporting module',
    'portfolio.project7.image1.caption': 'Main system dashboard',

    'portfolio.project8.challenge': 'The company needed an attractive digital presence that reflected the premium nature of their vehicles and facilitated online bookings for tourists in Miami.',
    'portfolio.project8.solution': 'We created a modern landing page with elegant design, premium vehicle gallery, instant quote system, and conversion optimization.',
    'portfolio.project8.results': '65% increase in booking requests, improved local search ranking, and smooth user experience that reflects service quality.',
    'portfolio.project8.client': 'Elite Rent Group - Miami',
    'portfolio.project8.feature1': 'Responsive and modern design',
    'portfolio.project8.feature2': 'Premium vehicle gallery',
    'portfolio.project8.feature3': 'Instant quote system',
    'portfolio.project8.feature4': 'SEO optimization for local searches',
    'portfolio.project8.image1.caption': 'Elite Rent Group homepage',
